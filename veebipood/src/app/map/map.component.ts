...
export class MapComponent implements AfterViewInit {
  ...
  changeMapFocus(centerZoome: {center: L.LatLngExpression, zoom: number}) {
    this.map.setView(centerZoome.center, centerZoome.zoom);
  }
